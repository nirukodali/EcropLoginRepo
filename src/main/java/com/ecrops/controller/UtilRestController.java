...
import com.ecrops.partitions.AllocatedSurveyNoPartition;
import com.ecrops.partitions.AuthMAOvaaVroEkycPartition;
import com.ecrops.partitions.BlockedEfishExtentPartition;
import com.ecrops.partitions.CropBookingDetailsMaoIntfPartition;
import com.ecrops.partitions.CropInsAbstracttPartition;
import com.ecrops.partitions.CropInsGrievancePartition;
...
import com.ecrops.partitions.DeviceRegDetailsPartition;
import com.ecrops.partitions.EfishDetailsRCPartition;
import com.ecrops.partitions.EmployeeListPartition;
import com.ecrops.partitions.FarmerDetailsPartition;
import com.ecrops.partitions.MaoSocialAuditcorrectionPartition;
import com.ecrops.partitions.NonWebViewPartition;
import com.ecrops.partitions.NormalAreasMwiseMaoPartition;
import com.ecrops.partitions.ObjUnobjPartition;
import com.ecrops.partitions.PhyAckVwisePartition;
import com.ecrops.partitions.RbkSurveyNoMappingDrpdwnPartitions;
import com.ecrops.partitions.RepLandDataDetailsPartition;
import com.ecrops.partitions.RepPernnialMandPartition;
import com.ecrops.partitions.RepVaaDetailsPartition;
...
import com.ecrops.partitions.SupercheckVillPartition;
...
//=====================RepLandDataDetails=========================//
	...
	List<RepLandDataDetails> getDwnloadedDet1(@RequestBody RequestModel requestModel) throws SQLException {
		System.out.println("requestModel=>" + requestModel.toString());
...
//	@GetMapping("/villLandData")
//	public List<Rep_VillLandDataDetails> getVillLandData( String dcode, 
...
//		
//		if(cropyear.equals(2023)) {
//			
//			list = repLandDataDetailsRepo.getVillData(Integer.parseInt(dcode),
//					Integer.parseInt(mcode));
//	}
//				else if(cropyear.equals(2024)) {
//				
//					list = repLandDataDetailsRepo.getVillData4(Integer.parseInt(dcode),
//							Integer.parseInt(mcode));
//			}else {
//			
//				list = repLandDataDetailsRepo.getVillDataP(Integer.parseInt(dcode),
//						Integer.parseInt(mcode));
//			}
//		
//		 
