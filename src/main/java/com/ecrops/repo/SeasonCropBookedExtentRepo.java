...
//         List<CropInsAbstractt>getCropInss(@Param("dcode") Integer dcode);
//	
//	  public interface CropInsAbstractt{
//		 String getDistrict();
//		 String getMandal();
//		 String getRbkname();
//		 BigDecimal getYb_farmers();
//		 BigDecimal getYb_extent();
//		 BigDecimal getYb_claimamt();
//		 BigDecimal getWb_farmers();
//		 BigDecimal getWb_extent();
//		 BigDecimal getWb_claimamt();
//		
//	}
}
